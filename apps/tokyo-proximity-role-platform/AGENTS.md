# AGENTS — 東京10分生活圏・地域役割プラットフォーム エージェントハーネス

原本: [`docs/design/20260823-tokyo-proximity-role-platform/20260823-tokyo-proximity-role-platform-agent-harness.md`](../../docs/design/20260823-tokyo-proximity-role-platform/20260823-tokyo-proximity-role-platform-agent-harness.md)

実行時の正本は本ファイルとする。運用規約の変更は `DECISIONS.md` にADRを追加したうえで反映する。

---

この文書は、`apps/tokyo-proximity-role-platform/` の実行規約である。
